    ...
    return (
      <div className="App">
        ...
        <Switch>
          ...
          <Route path="/dashboard/article/edit/:id" component={DBArticle} exact />
          <Route path="/dashboard/articles" component={DBArticles} exact />

          {/* Reivewer links */}
          <Route path="/dashboard/reviews" component={DBCard} exact />
          <Route path="/dashboard/review/article/:id" component={DBArticle} exact />
          <Route path="/dashboard/review/card/:id" component={DBArticles} exact />
          <Route path="/dashboard/review/test/:id" component={DBArticles} exact />

          {/* Dashboard users links */}
